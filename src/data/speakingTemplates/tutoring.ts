...
export const tutoringLessons: SpeakingTemplate[] = [
  ...
  },
  {
    ...
    description: 'Develop natural speaking flow and confidence',
  ...
  },
  {
    ...
    description: 'Master advanced vocabulary for IELTS topics',
...
Start with a warm greeting and then explain that you'll help them practice speaking while providing feedback and support. Maintain an encouraging and positive tone throughout.`,
  ...
  },
  {
    ...
    description: 'Expand your vocabulary with advanced expressions and collocations',
...
- Active usage`,
  ...
  },
  {
    ...
    description: 'Master advanced grammar patterns for higher band scores',
...
- Real context usage`,
  ...
  },
  {
    ...
    description: 'Improve your speaking fluency and natural expression',
